...
* Share the resources with others, under the following terms:
  ...
  * Use an excerpt from the webpage if necessary (don’t copy the full article
...
* You can NOT copy the full webpage and display it on your own website. (Use
  an excerpt by all means, but please link to the original resource download
  page – not the actual file.)
**/
var Base64 = {
